...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/authoracoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/core_write.cpp \
           src/crypter.cpp \
           src/authoracoin-cli.cpp \
           src/authoracoin-tx.cpp \
           src/authoracoin.cpp \
           src/db.cpp \
           ...
           src/qt/authoracoin.cpp \
           src/qt/authoracoinstrings.cpp \
...
RESOURCES += src/qt/authoracoin.qrc src/qt/authoracoin_locale.qrc

TRANSLATIONS += src/qt/locale/authoracoin_bg.ts \
                src/qt/locale/authoracoin_de.ts \
                src/qt/locale/authoracoin_en.ts \
                src/qt/locale/authoracoin_es.ts \
                src/qt/locale/authoracoin_fi.ts \
                src/qt/locale/authoracoin_fr.ts \
                src/qt/locale/authoracoin_it.ts \
                src/qt/locale/authoracoin_ja.ts \
                src/qt/locale/authoracoin_pl.ts \
                src/qt/locale/authoracoin_pt.ts \
                src/qt/locale/authoracoin_ru.ts \
                src/qt/locale/authoracoin_sk.ts \
                src/qt/locale/authoracoin_sv.ts \
                src/qt/locale/authoracoin_vi.ts \
                src/qt/locale/authoracoin_zh_CN.ts \
                src/qt/locale/authoracoin_zh_TW.ts
