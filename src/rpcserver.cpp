...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Authoracoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Authoracoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Authoracoin features */
        {"authoracoin", "masternode", &masternode, true, true, false},
        {"authoracoin", "listmasternodes", &listmasternodes, true, true, false},
        {"authoracoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"authoracoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"authoracoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"authoracoin", "masternodedebug", &masternodedebug, true, true, false},
        {"authoracoin", "startmasternode", &startmasternode, true, true, false},
        {"authoracoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"authoracoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"authoracoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"authoracoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"authoracoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"authoracoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"authoracoin", "mnbudget", &mnbudget, true, true, false},
        {"authoracoin", "preparebudget", &preparebudget, true, true, false},
        {"authoracoin", "submitbudget", &submitbudget, true, true, false},
        {"authoracoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"authoracoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"authoracoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"authoracoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"authoracoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"authoracoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"authoracoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"authoracoin", "checkbudgets", &checkbudgets, true, true, false},
        {"authoracoin", "mnsync", &mnsync, true, true, false},
        {"authoracoin", "spork", &spork, true, true, false},
        {"authoracoin", "preparecommunityproposal", &preparecommunityproposal, true, true, false},
        {"authoracoin", "submitcommunityproposal", &submitcommunityproposal, true, true, false},
        {"authoracoin", "getcommunityinfo", &getcommunityinfo, true, true, false},
        {"authoracoin", "checkcommunityproposals", &checkcommunityproposals, true, true, false},
        {"authoracoin", "getcommunityproposalvotes", &getcommunityproposalvotes, true, true, false},
        {"authoracoin", "mncommunityvote", &mncommunityvote, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> authoracoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:23855/\n";
}
