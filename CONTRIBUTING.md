Contributing to Authoracoin Core
==================================

The Authoracoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Authoracoin Core project, and is not to be
confused with overall Authoracoin Network Protocol consensus changes.

Whether a pull request is merged into Authoracoin Core rests with the project merge
...
Patches that change Authoracoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Authoracoin consensus, it must have been
...
The project leader is the release manager for each Authoracoin Core release.
