...
In order to support loading of multiple wallets in authoracoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is authoracoin.cpp.
...
Changes to authoracoin.cpp
----------------------
authoracoin.cpp is the entry point into authoracoin-qt, and as such, will require some minor modifications to provide hooks for
